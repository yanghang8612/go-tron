...
var KnownVersions = []VersionParam{
	...
	{35, 1596780000000, 70}, // VERSION_4_8_1_1
	{36, 1596780000000, 80}, // VERSION_4_8_2
	{37, 1596780000000, 80}, // VERSION_4_8_2_PQ1 (Nile only; tracked for replay even before gtron advertises it)
}
