...
// LoadDynamicPropertiesStrict builds DynamicProperties from persisted state and
// returns storage/corruption errors to callers that must not silently fall back
// to defaults (API/live archive read paths).
