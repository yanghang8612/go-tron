...
var inspectPrefixes = []inspectKeyspace{
	...
	{name: "state-change-posting", pattern: "state-change-posting-v3-*", prefix: stateChangePostingPrefix},
	{name: "state-change-key-directory", pattern: "state-change-keys-v3-*", prefix: stateChangeKeyDirectoryPrefix},
