...
const (
	...
	// second worker from foreground sync. A 3 GiB live A/B reduced block
	// throughput by 12% while increasing compaction CPU/input by 23% and
	// disk/input by 14%, so deferring that worker further is counterproductive.
