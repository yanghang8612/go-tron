...
func TestClassifyPhysicalKeyString(t *testing.T) {
	tests := []struct {
		...
		{"state-tx-range-v1-row", PhysicalKeyFamilyStateTxRange},
		{"state-changeset-v2-row", PhysicalKeyFamilyStateChangeSet},
		{"state-change-posting-v3-row", PhysicalKeyFamilyStateChangeIndex},
		{"state-change-keys-v3-row", PhysicalKeyFamilyStateChangeIndex},
		...
		{"execution-safety-qualified-v1", PhysicalKeyFamilyChainMetadata},
