...
// TransactionIndexLocationBlock returns the block component of either a
// legacy block-only value or a packed block/ordinal value.
func TransactionIndexLocationBlock(location uint64) uint64 {
	return transactionIndexLocationBlock(location)
}
