...
| M11.4 total_create_witness_cost counter | 完成 | 2026-04-29 | 待提交 | DP 加 total_create_witness_cost 键 + AddTotalCreateWitnessCost helper；WitnessCreateActuator.Execute 在 burnFee 后累加 fee。1 单测。total_create_account_cost 类似 counter 留待 BandwidthProcessor 加 consumeFeeForCreateNewAccount fallback 时一并接入（不在 M11 范围）。 |
