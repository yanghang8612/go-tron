...
RELEASE = Path('/data/gtron/releases/20260910-history-metadata')
SOURCE = RELEASE / 'source'
BINARY = RELEASE / 'gtron'
OLD_EXE = '/data/gtron/releases/20260910-history-readiness/gtron'
OLD_SHA = 'c84fee73d08425cdf189467129e9382f76fddb0f733fa788d1dc44dd23ac1915'
OLD_PID = 6479
BASE_PREFIX = '19eda11f44424f673a40b06051edcbf629b50846'
RELEASE_KIND = 'history-metadata-git-20260910'
SCRIPT_PATH = 'scripts/deploy_history_metadata_20260910.py'
...
EXPECTED_FILES = {
    "core/blockbuffer/base_read_cache.go": "8f2d291d9da28eaf473d9e09295c26c879d666585b7174c85138824042af2a70",
    "core/blockbuffer/base_read_cache_diagnostics.go": "d46d3fbfc1492535ed18e519822f0d355a9022189bca57de0e2e666f412f9a89",
    "core/blockbuffer/base_read_cache_diagnostics_bench_test.go": "30b856143d69d2efef3fd990539827258b7af461a2be1c4815613839d76d7a18",
    "core/blockbuffer/base_read_cache_diagnostics_test.go": "98bd81d856b3398ff35e633c6084baf11c55e30bb3ea31f4fa2c163e8ffd72f9",
    "core/blockbuffer/base_read_cache_test.go": "8947734f96053784923bff9490bca860483b708929763a3f12c73763a872658f",
    "core/blockbuffer/buffer.go": "11b2db746bdde318ea84fe4c8c6f54ae7e19b1c0c80041d31daac27569560fed",
    "core/blockbuffer/layer_view.go": "9efaa55040a7acfadf03a66345c5b943d7f7d40928ecbeb404446c6233e7c5b5",
    "core/state/snapshots/history_load.go": "2f9b5ca470976223e294af4a8066deae961448389036a46f872cfbdc821ec4b8",
    "core/state/snapshots/history_load_test.go": "c295403948931b96d4d3a2ec0e21632de9a0aaf5181e81e613e42bdb01a5210d",
    "core/state/snapshots/manifest.go": "e14f4da3a2decd74a008e43d98947f262c07af1566424c9e63da83068afa113c",
    "core/state/snapshots/manifest_cache.go": "7f8fb28d27b243b40267677d2d398b8288b3e84497481c86ced266e2e60bdd11",
    "core/state/snapshots/manifest_publication_cache_bench_test.go": "d3141842053aa3a7baf755832ced13d3b1b457efc42b474556ee432cebc53d71",
    "core/state/snapshots/manifest_publication_cache_test.go": "ec6560d2b18dbf014cdd2d9a806be6cbcb1195c166f7a4132b5458efab6b6d0f",
    "core/state/state_code_copy_test.go": "dd78430a2b9cb94c89869be108c0f46a5c1a3cdaa1dc363cdc0bf83a16f4a550",
    "core/state/statedb.go": "3e26ca209fd972d4465db17175f7f6863ddd91f083971de8af9f6ebc109c6ced",
    "core/state_processor_test.go": "14bdf93bdad68b899843d2c38b4e2649ad0e951372f19da3a3813ffd944ec8fd",
    "scripts/deploy_history_readiness_20260910.py": "db7ac243a21f2506f5be10b56cc55533e5a860a5f757459263b207c37cf5aab5"
}
...
def validate_revision(revision, script_revision):
    ...
    feature_ref = 'refs/remotes/origin/perf/history-metadata-diagnostics-20260910'
    feature_tip = resolve_commit(feature_ref)
    require(feature_tip == script_revision, 'fetched release branch tip differs from pinned ops commit')
    admitted_refs = [{'ref': feature_ref, 'commit': feature_tip}]
...
def prepare(args):
    ...
    test_pattern = ('Test(ProcessBlockPublishesBoundaryReadyAsyncVMRetry|Manifest|History|RuntimeHistory|StateDBCop|StateCode|StrictObject|CodeVerification|GetCodeStrict|CommitmentParent|ReturnCommitmentParent|BaseReadCache|EmptyRootsVector|'
                    'AppendCommitmentsVector|CombineKnownDepth25)')
    run([go, 'test', '-p', '2', '-tags', 'sapling', './cmd/gtron', './core', './core/state', './core/blockbuffer',
         './core/state/snapshots', './core/zksnark', '-run', test_pattern, '-count=1', '-timeout=300s', '-v'],
