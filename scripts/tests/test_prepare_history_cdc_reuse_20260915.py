...
PATH = ROOT / 'scripts/prepare_history_cdc_reuse_20260915.py'
...
class PreparePipelineTests(unittest.TestCase):
    ...
    def test_scope_is_explicit_and_default_service_is_absent(self):
        ...
        self.assertIn('core/state/snapshots/compressed_block_cdc_writer.go', builder.REQUIRED_SOURCE_CHANGES)
        ...
        self.assertIn('CDCDigestReuse', builder.TEST_PATTERN)
