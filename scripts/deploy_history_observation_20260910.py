...
RELEASE = Path('/data/gtron/releases/20260910-history-observation')
SOURCE = RELEASE / 'source'
BINARY = RELEASE / 'gtron'
OLD_EXE = '/data/gtron/releases/20260910-history-admission/gtron'
OLD_SHA = 'ba071c728499e7ca02733deca765fc717290b1b76374157f7a6d92d1a3125deb'
OLD_PID = 32233
BASE_PREFIX = '0ab5b6d14c5a647fe381377d51a1c521d3a53879'
...
RELEASE_KIND = 'history-observation-git-20260910'
SCRIPT_PATH = 'scripts/deploy_history_observation_20260910.py'
...
EXPECTED_FILES = {'core/state/pruning/lifecycle.go': '75fea916810a3d3add94b79a6389653a7071d841d5ea56f181855bd46cb7d987',
 'core/state/pruning/lifecycle_resource_observation_test.go': '697da662e0f1900a35db7e9aebb238f7e0ae8d830e0a4eb8c5cb315bf1bb0b60',
 'core/state/snapshots/cold_builder.go': '44b6a0ad541b5595006d5e78074050d7fc479881d5fb08b5fedd2d9a7e678236',
 'core/state/snapshots/history_busy_observation_test.go': 'a95ae3656779614aacf2a4a5c4f14f2f1d710b8a16f8d21346f35360ac567b07',
 'core/state/snapshots/history_busy_observation_trace_test.go': 'bccc6f4bd20c98488674fdf32379110cd8d3a7142c8eaba647fa40c0ae958037',
 'core/state/snapshots/history_busy_resource.go': 'b8ad201ce7e00dd96c86fb55b2e6c5797b58feb64cf4576c972c455e328adcef',
 'core/state/snapshots/history_catchup.go': '42088a981e6d22fcf602f3e5c486a242aee33b5c544b3b0449bedc4ee998eec8',
 'scripts/deploy_history_admission_20260910.py': '68dc992400c4690a491bb606dc0e2b37756a6ee8cff10b3c4124545c5979df27'}
...
def prepare(args):
    ...
    progress('prepare: complete native pruning package tests, including lightweight recovery observation')
    run([go, 'test', '-p', '2', '-tags', 'sapling', './core/state/pruning',
         '-count=1', '-timeout=300s', '-v'],
        cwd=SOURCE, env=env, timeout=1800, log='native-pruning-tests.log')
