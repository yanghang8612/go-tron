    ...
    def test_sample_includes_sync_health_and_disk_ratios(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            sync_log.write_text(
                "\n".join(
                    [
                        "INFO [06-13|11:59:50.000] Sync startup repair summary syncStartupRepairComplete=true syncStartupRepairKept=4 syncStartupRepairMissing=0 syncStartupRepairDeleted=0 syncStartupRepairHasBlocked=false syncStartupRepairFirstBlocked= syncStartupRepairInterrupted=false syncStartupRepairErrorStage= syncStartupRepairRows=4 syncStartupStagedRestored=0 syncStartupStagedTargetHead=90 syncStartupStagedNextExpected=91 syncStartupStagedNeedPruneTail=false syncStartupStagedPruneFrom=0 syncStartupStagedHaveLastRestored=false syncStartupStagedLastRestored=0",
