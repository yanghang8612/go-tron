...
Options:
  ...
  --archive-api-call-data HEX
                              Include eth_call, debug_traceCall, and eth_estimateGas with this calldata against archive-api-address
...
def parse_sync_log(path):
    row = {
        ...
        "syncLogStatePrefetchEnqueued": -1,
        "syncLogStatePrefetchDropped": -1,
        "syncLogStatePrefetchProcessed": -1,
        "syncLogStatePrefetchHits": -1,
        "syncLogStatePrefetchMisses": -1,
        "syncLogStatePrefetchErrors": -1,
        ...
        "syncLogPhaseCursorCurrentTaskCount": -1,
        "syncLogPhaseCursorCurrentTaskRemaining": -1,
        "syncLogPhaseCursorCurrentFromBlock": -1,
        "syncLogPhaseCursorCurrentToBlock": -1,
        ...
        "syncStartupHeadCompletionChecked": False,
        "syncStartupHeadCompletionHasPrefix": False,
        "syncStartupHeadCompletionLastStage": "",
        "syncStartupHeadCompletionLastBlock": -1,
        "syncStartupHeadCompletionFillStages": -1,
        "syncStartupHeadCompletionWritten": -1,
        "syncStartupHeadCompletionComplete": False,
    ...
    if latest_startup is not None:
        ...
        startup_mappings = {
            ...
            "syncStartupHeadCompletionChecked": "syncStartupHeadCompletionChecked",
            "syncStartupHeadCompletionHasPrefix": "syncStartupHeadCompletionHasPrefix",
            "syncStartupHeadCompletionLastStage": "syncStartupHeadCompletionLastStage",
            "syncStartupHeadCompletionLastBlock": "syncStartupHeadCompletionLastBlock",
            "syncStartupHeadCompletionFillStages": "syncStartupHeadCompletionFillStages",
            "syncStartupHeadCompletionWritten": "syncStartupHeadCompletionWritten",
            "syncStartupHeadCompletionComplete": "syncStartupHeadCompletionComplete",
            "syncStartupHeadCompletionErrorStage": "syncStartupHeadCompletionErrorStage",
    ...
    mappings = {
        ...
        "statePrefetchEnqueued": "syncLogStatePrefetchEnqueued",
        "statePrefetchDropped": "syncLogStatePrefetchDropped",
        "statePrefetchProcessed": "syncLogStatePrefetchProcessed",
        "statePrefetchHits": "syncLogStatePrefetchHits",
        "statePrefetchMisses": "syncLogStatePrefetchMisses",
        "statePrefetchErrors": "syncLogStatePrefetchErrors",
        ...
        "syncPhaseCursorCurrentTaskCount": "syncLogPhaseCursorCurrentTaskCount",
        "syncPhaseCursorCurrentTaskRemaining": "syncLogPhaseCursorCurrentTaskRemaining",
        "syncPhaseCursorCurrentFromBlock": "syncLogPhaseCursorCurrentFromBlock",
        "syncPhaseCursorCurrentToBlock": "syncLogPhaseCursorCurrentToBlock",
        "syncPhaseCursorNextBlock": "syncLogPhaseCursorNextBlock",
        "syncPhaseCursorNextPhase": "syncLogPhaseCursorNextPhase",
        "syncPhaseCursorNextCanonical": "syncLogPhaseCursorNextCanonical",
        "syncPhaseCursorNextSync": "syncLogPhaseCursorNextSync",
...
SAMPLE_PROMETHEUS_NUMERIC_FIELDS = (
    ...
    ("gtron_nile_sync_log_phase_cursor_completed_phases", "syncLogPhaseCursorCompletedPhases", "Sync import phase-cursor phases completed in the latest sampled sync log segment."),
    ("gtron_nile_sync_log_phase_cursor_scheduled_phases", "syncLogPhaseCursorScheduledPhases", "Sync import phase-cursor phases scheduled in the latest sampled sync log segment."),
    ("gtron_nile_sync_log_phase_cursor_incomplete_phases", "syncLogPhaseCursorIncompletePhases", "Sync import phase-cursor phases still incomplete in the latest sampled sync log segment."),
    ("gtron_nile_sync_log_phase_cursor_completed_tasks", "syncLogPhaseCursorCompletedTasks", "Sync import phase-cursor tasks completed in the latest sampled sync log segment."),
    ("gtron_nile_sync_log_phase_cursor_scheduled_tasks", "syncLogPhaseCursorScheduledTasks", "Sync import phase-cursor tasks scheduled in the latest sampled sync log segment."),
    ("gtron_nile_sync_log_phase_cursor_current_task_index", "syncLogPhaseCursorCurrentTaskIndex", "Sync import phase-cursor current task index in the latest sampled sync log segment."),
    ("gtron_nile_sync_log_phase_cursor_current_task_count", "syncLogPhaseCursorCurrentTaskCount", "Sync import phase-cursor current phase task count in the latest sampled sync log segment."),
    ("gtron_nile_sync_log_phase_cursor_current_task_remaining", "syncLogPhaseCursorCurrentTaskRemaining", "Sync import phase-cursor tasks remaining in the current phase for the latest sampled sync log segment."),
    ("gtron_nile_sync_log_phase_cursor_current_from_block", "syncLogPhaseCursorCurrentFromBlock", "Sync import phase-cursor current phase start block in the latest sampled sync log segment."),
    ("gtron_nile_sync_log_phase_cursor_current_to_block", "syncLogPhaseCursorCurrentToBlock", "Sync import phase-cursor current phase end block in the latest sampled sync log segment."),
    ("gtron_nile_sync_log_phase_cursor_next_block", "syncLogPhaseCursorNextBlock", "Sync import phase-cursor next block in the latest sampled sync log segment."),
    ...
    ("gtron_nile_sync_stage_sync_commitment_finish_lag_blocks", "stageSyncCommitmentFinishLagBlocks", "Lag between SyncCommitment and SyncFinish."),
    ("gtron_nile_sync_stage_sync_finish_head_lag_blocks", "stageSyncFinishHeadLagBlocks", "Lag between SyncFinish and sampled head."),
    ("gtron_nile_sync_stage_sync_pipeline_lag_blocks", "stageSyncPipelineLagBlocks", "Total lag across adjacent staged-sync edges."),
    ...
    ("gtron_nile_sync_interval_stage_sync_execution_blocks_per_second", "intervalStageSyncExecutionBlocksPerSecond", "Interval SyncExecution stage throughput in blocks per second."),
    ("gtron_nile_sync_interval_stage_sync_commitment_blocks_per_second", "intervalStageSyncCommitmentBlocksPerSecond", "Interval SyncCommitment stage throughput in blocks per second."),
    ("gtron_nile_sync_interval_stage_sync_finish_blocks_per_second", "intervalStageSyncFinishBlocksPerSecond", "Interval SyncFinish stage throughput in blocks per second."),
    ("gtron_nile_sync_interval_stage_chain_freezer_blocks_per_second", "intervalStageChainFreezerBlocksPerSecond", "Interval ChainFreezer stage throughput in blocks per second."),
    ("gtron_nile_sync_interval_stage_snapshot_event_log_build_blocks_per_second", "intervalStageSnapshotEventLogBuildBlocksPerSecond", "Interval SnapshotEventLogBuild stage throughput in blocks per second."),
    ...
    ("gtron_nile_sync_datadir_bytes_per_block", "bytesPerBlock", "Total datadir bytes per imported block."),
    ("gtron_nile_sync_chaindata_bytes_per_block", "chaindataBytesPerBlock", "Hot chaindata bytes per imported block."),
    ("gtron_nile_sync_cold_archive_bytes_per_block", "coldArchiveBytesPerBlock", "Cold archive bytes per imported block."),
    ("gtron_nile_sync_derived_index_bytes_per_block", "derivedIndexBytesPerBlock", "Derived cold index bytes per imported block."),
    ("gtron_nile_sync_soak_efficiency_datadir_bytes_per_block", "soakEfficiencyDatadirBytesPerBlock", "Selected soak-efficiency total datadir bytes per block."),
...
ARCHIVE_API_FILTERED_LOG_METHODS = (
    "eth_getLogsFiltered",
)
