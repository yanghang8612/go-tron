...
RELEASE = Path('/data/gtron/releases/20260910-state-hotpaths')
SOURCE = RELEASE / 'source'
BINARY = RELEASE / 'gtron'
OLD_EXE = '/data/gtron/releases/20260909-parallel-history-event-9059eb7f/gtron'
OLD_SHA = '2d3f9707c176c3e15b30d492d676e8594b483200a9569912b649ef7407bf4991'
OLD_PID = 25232
BASE_PREFIX = '9059eb7f'
RELEASE_KIND = 'state-hotpaths-git-20260910'
SCRIPT_PATH = 'scripts/deploy_state_hotpaths_20260910.py'
...
EXPECTED_FILES = {'actuator/withdraw_reward.go': '21d3e30fd782e6e5f477b1eaa2741f0583e8b8fc5cb7030b1faa9a0c9c265e81', 'actuator/withdraw_reward_reference_test.go': '44cc5719ca2bdd79f9d5ed294c0eea5fe0919682d80a14625fbaa2a57f7363a3', 'actuator/withdraw_reward_selective_test.go': '490c143cb27d06875f271901e2b0f57995e40fa3af558f8cbfbf204fa485eef5', 'core/state/account_votes.go': '767dd149a0762225a20ee593f383c682bb20670d452988f06822226993839cd3', 'core/state/account_votes_cache_test.go': 'd04fc849abd045ca6ae1c9bdf2fe018a805c236aeaf8448e63b2f7852db09194', 'core/state/contract_runtime_metadata.go': 'f218043dee7f3df1f68288cf836afce195e4625f1698f792f8f79de34784b9de', 'core/state/contract_runtime_metadata_test.go': '16ed1579cd164059bbaaa4e1025ab7c0f5b03b21ad632e70cd48be0e9103658a', 'core/state/statecodec/contract_runtime.go': 'fc0416081b23b5a2ee2b0b91b9d1376a347f50eecd439c865f543e5752b4d8cc', 'core/state/statecodec/contract_runtime_test.go': '272bd3579d94f2174500411ad0f20c1d804305f14b489ddf4ca4859178555d03', 'core/state/transaction_access.go': 'e493762a876108cbe9292e52ee21724e0c1e08ec3d7c0442a6a3bbeec40f90a3', 'core/state/transaction_access_scratch_test.go': '1d08fce2a00e921f7f4521ef252706d7f4094b67e2fd7a7fe5d931b286d5d23f'}
...
def validate_revision(revision, script_revision):
    ...
    for line in diff.splitlines():
        ...
        changed.add(name)
    require(ALLOWED <= changed, 'candidate must contain all eleven source changes')
    ...
    script_refs = []
    for ref in ['FETCH_HEAD', 'refs/remotes/origin/ops/deploy-state-hotpaths-20260910']:
        try:
            tip = resolve_commit(ref)
        except RuntimeError:
            continue
...
def prepare(args):
    ...
    test_pattern = ('Test(DecodeContractRuntime|ContractRuntime|AccountVotesCache|TransactionAccessAccountKVRetainsScratchKeys|'
                    'RewardSelective|WithdrawRewardSelective|EmptyRootsVector|AppendCommitmentsVector|'
                    'CombineKnownDepth25)')
    run([go, 'test', '-p', '2', '-tags', 'sapling', './core/state', './core/state/statecodec',
         './actuator', './core/zksnark', '-run', test_pattern, '-count=1', '-timeout=300s', '-v'],
