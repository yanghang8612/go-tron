...
func TestStats_AddApplyBlockSumsPerPhase(t *testing.T) {
	...
	s.AddApplyBlock(core.ApplyStats{
		...
		StateCommitDetail: state.CommitStats{
			...
			AccountTrieMarshal:    3 * time.Millisecond,
			AccountTrieGeneration: 4 * time.Millisecond,
			AccountTrieWrite:      5 * time.Millisecond,
			Accounts:              3,
			KVAccounts:            2,
			KVItems:               5,
			Mutations:             mut1,
	...
	s.AddApplyBlock(core.ApplyStats{
		...
		StateCommitDetail: state.CommitStats{
			...
			AccountTrieMarshal:    30 * time.Millisecond,
			AccountTrieGeneration: 40 * time.Millisecond,
			AccountTrieWrite:      50 * time.Millisecond,
			Accounts:              30,
			KVAccounts:            20,
			KVItems:               50,
			Mutations:             mut2,
	...
	want := core.ApplyStats{
		...
		StateCommitDetail: state.CommitStats{
			...
			AccountTrieMarshal:    33 * time.Millisecond,
			AccountTrieGeneration: 44 * time.Millisecond,
			AccountTrieWrite:      55 * time.Millisecond,
			Accounts:              33,
			KVAccounts:            22,
			KVItems:               55,
