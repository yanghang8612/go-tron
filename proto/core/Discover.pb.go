...
type Endpoint struct {
	...
	AddressIpv6   []byte                 `protobuf:"bytes,4,opt,name=addressIpv6,proto3" json:"addressIpv6,omitempty"`
...
func (x *Endpoint) GetAddressIpv6() []byte {
	if x != nil {
...
const file_core_Discover_proto_rawDesc = "" +
	"\n" +
	"\x13core/Discover.proto\x12\bprotocol\"r\n" +
	"\bEndpoint\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\fR\aaddress\x12\x12\n" +
	"\x04port\x18\x02 \x01(\x05R\x04port\x12\x16\n" +
	"\x06nodeId\x18\x03 \x01(\fR\x06nodeId\x12 \n" +
	"\vaddressIpv6\x18\x04 \x01(\fR\vaddressIpv6\"\x91\x01\n" +
	"\vPingMessage\x12&\n" +
	...
	"\bpriority\x18\x02 \x01(\x05R\bpriorityBG\n" +
	"\x0forg.tron.protosB\bDiscoverZ*github.com/tronprotocol/go-tron/proto/coreb\x06proto3"
