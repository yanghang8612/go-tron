...
const (
	PQScheme_UNKNOWN_PQ_SCHEME PQScheme = 0
	PQScheme_FN_DSA_512        PQScheme = 1
	PQScheme_ML_DSA_44         PQScheme = 2
)

// Enum value maps for PQScheme.
var (
	PQScheme_name = map[int32]string{
		0: "UNKNOWN_PQ_SCHEME",
		1: "FN_DSA_512",
		2: "ML_DSA_44",
	}
	PQScheme_value = map[string]int32{
		"UNKNOWN_PQ_SCHEME": 0,
		"FN_DSA_512":        1,
		"ML_DSA_44":         2,
	}
...
func (x PQScheme) Enum() *PQScheme {
	p := new(PQScheme)
	*p = x
	return p
}

func (x PQScheme) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PQScheme) Descriptor() protoreflect.EnumDescriptor {
	return file_core_Tron_proto_enumTypes[1].Descriptor()
}

func (PQScheme) Type() protoreflect.EnumType {
	return &file_core_Tron_proto_enumTypes[1]
}

func (x PQScheme) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PQScheme.Descriptor instead.
func (PQScheme) EnumDescriptor() ([]byte, []int) {
...
func (Permission_PermissionType) EnumDescriptor() ([]byte, []int) {
	return file_core_Tron_proto_rawDescGZIP(), []int{18, 0}
}
...
func (Transaction_Contract_ContractType) EnumDescriptor() ([]byte, []int) {
	return file_core_Tron_proto_rawDescGZIP(), []int{26, 0, 0}
}
...
func (Transaction_ResultCode) EnumDescriptor() ([]byte, []int) {
	return file_core_Tron_proto_rawDescGZIP(), []int{26, 1, 0}
}
...
const (
	...
	Transaction_Result_INVALID_CODE         Transaction_ResultContractResult = 15 // please fill in the order according to the serial number
)
...
func (Transaction_ResultContractResult) EnumDescriptor() ([]byte, []int) {
	return file_core_Tron_proto_rawDescGZIP(), []int{26, 1, 1}
}
...
func (TransactionInfoCode) EnumDescriptor() ([]byte, []int) {
	return file_core_Tron_proto_rawDescGZIP(), []int{27, 0}
}
...
func (Items_ItemType) EnumDescriptor() ([]byte, []int) {
	return file_core_Tron_proto_rawDescGZIP(), []int{35, 0}
}
...
func (PBFTMessage_MsgType) EnumDescriptor() ([]byte, []int) {
	return file_core_Tron_proto_rawDescGZIP(), []int{43, 0}
}
...
func (PBFTMessage_DataType) Descriptor() protoreflect.EnumDescriptor {
	return file_core_Tron_proto_enumTypes[14].Descriptor()
}

func (PBFTMessage_DataType) Type() protoreflect.EnumType {
	return &file_core_Tron_proto_enumTypes[14]
}
...
func (PBFTMessage_DataType) EnumDescriptor() ([]byte, []int) {
	return file_core_Tron_proto_rawDescGZIP(), []int{43, 1}
}
...
type Account struct {
	...
	Asset map[string]int64 `protobuf:"bytes,6,rep,name=asset,proto3" json:"asset,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	// the other asset owned by this account，key is assetId
	AssetV2 map[string]int64 `protobuf:"bytes,56,rep,name=assetV2,proto3" json:"assetV2,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	...
	LatestAssetOperationTime   map[string]int64 `protobuf:"bytes,18,rep,name=latest_asset_operation_time,json=latestAssetOperationTime,proto3" json:"latest_asset_operation_time,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	LatestAssetOperationTimeV2 map[string]int64 `protobuf:"bytes,58,rep,name=latest_asset_operation_timeV2,json=latestAssetOperationTimeV2,proto3" json:"latest_asset_operation_timeV2,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	FreeNetUsage               int64            `protobuf:"varint,19,opt,name=free_net_usage,json=freeNetUsage,proto3" json:"free_net_usage,omitempty"`
	FreeAssetNetUsage          map[string]int64 `protobuf:"bytes,20,rep,name=free_asset_net_usage,json=freeAssetNetUsage,proto3" json:"free_asset_net_usage,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	FreeAssetNetUsageV2        map[string]int64 `protobuf:"bytes,59,rep,name=free_asset_net_usageV2,json=freeAssetNetUsageV2,proto3" json:"free_asset_net_usageV2,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
...
func (x *PQAuthSig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PQAuthSig) ProtoMessage() {}

func (x *PQAuthSig) ProtoReflect() protoreflect.Message {
	mi := &file_core_Tron_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PQAuthSig.ProtoReflect.Descriptor instead.
func (*PQAuthSig) Descriptor() ([]byte, []int) {
	return file_core_Tron_proto_rawDescGZIP(), []int{15}
}

func (x *PQAuthSig) GetScheme() PQScheme {
	if x != nil {
		return x.Scheme
	}
	return PQScheme_UNKNOWN_PQ_SCHEME
}

func (x *PQAuthSig) GetPublicKey() []byte {
	if x != nil {
		return x.PublicKey
	}
	return nil
...
func (x *PQAuthSig) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
type ResourceReceipt struct {
	...
	// Diagnostic (cross-impl parity): available energy of the contract origin /
	// caller captured at the start of contract execution, before the energy bill.
	// Recorded unconditionally (incl. pre-Stake-2.0) to pinpoint energy-recovery
...
func (x *ResourceReceipt) GetOriginEnergyLeft() int64 {
	if x != nil {
		return x.OriginEnergyLeft
	}
	return 0
}
...
func (x *Transaction) GetPqAuthSig() []*PQAuthSig {
	if x != nil {
		return x.PqAuthSig
	}
	return nil
...
type TransactionInfo struct {
	...
	CancelUnfreezeV2Amount        map[string]int64       `protobuf:"bytes,29,rep,name=cancel_unfreezeV2_amount,json=cancelUnfreezeV2Amount,proto3" json:"cancel_unfreezeV2_amount,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
func (x *BlockHeader) GetPqAuthSig() *PQAuthSig {
	if x != nil {
		return x.PqAuthSig
	}
	return nil
...
func (x *HelloMessage) GetPqAuthSig() *PQAuthSig {
	if x != nil {
		return x.PqAuthSig
	}
	return nil
...
type NodeInfo struct {
	...
	CheatWitnessInfoMap map[string]string        `protobuf:"bytes,11,rep,name=cheatWitnessInfoMap,proto3" json:"cheatWitnessInfoMap,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (*SRL) Descriptor() ([]byte, []int) {
	return file_core_Tron_proto_rawDescGZIP(), []int{45}
}
...
type Account_Frozen struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FrozenBalance int64                  `protobuf:"varint,1,opt,name=frozen_balance,json=frozenBalance,proto3" json:"frozen_balance,omitempty"` // the frozen trx or asset balance
...
func (*TXInputRaw) Descriptor() ([]byte, []int) {
	return file_core_Tron_proto_rawDescGZIP(), []int{22, 0}
}
...
type Transaction_Result struct {
	...
	CancelUnfreezeV2Amount        map[string]int64                 `protobuf:"bytes,28,rep,name=cancel_unfreezeV2_amount,json=cancelUnfreezeV2Amount,proto3" json:"cancel_unfreezeV2_amount,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
func (*Transaction_Result) Descriptor() ([]byte, []int) {
	return file_core_Tron_proto_rawDescGZIP(), []int{26, 1}
}
...
func (x *TransactionRaw) Reset() {
	*x = TransactionRaw{}
	mi := &file_core_Tron_proto_msgTypes[61]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TransactionRaw) Descriptor() ([]byte, []int) {
	return file_core_Tron_proto_rawDescGZIP(), []int{26, 2}
}
...
func (x *TransactionInfo_Log) Reset() {
	*x = TransactionInfo_Log{}
	mi := &file_core_Tron_proto_msgTypes[63]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *InternalTransaction_CallValueInfo) Reset() {
	*x = InternalTransaction_CallValueInfo{}
	mi := &file_core_Tron_proto_msgTypes[69]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InternalTransaction_CallValueInfo) Descriptor() ([]byte, []int) {
	return file_core_Tron_proto_rawDescGZIP(), []int{39, 0}
}
...
func (*MetricsInfo_RateInfo) Descriptor() ([]byte, []int) {
	return file_core_Tron_proto_rawDescGZIP(), []int{42, 2}
}
...
func (*MetricsInfo_NetInfo) Descriptor() ([]byte, []int) {
	return file_core_Tron_proto_rawDescGZIP(), []int{42, 3}
}
...
func (*MetricsInfo_BlockChainInfo_Witness) Descriptor() ([]byte, []int) {
	return file_core_Tron_proto_rawDescGZIP(), []int{42, 1, 0}
}
...
func (*MetricsInfo_BlockChainInfo_DupWitness) Descriptor() ([]byte, []int) {
	return file_core_Tron_proto_rawDescGZIP(), []int{42, 1, 1}
}
...
func (*MetricsInfo_NetInfo_ApiInfo) Descriptor() ([]byte, []int) {
	return file_core_Tron_proto_rawDescGZIP(), []int{42, 3, 0}
}
...
func (*MetricsInfo_NetInfo_DisconnectionDetailInfo) Descriptor() ([]byte, []int) {
	return file_core_Tron_proto_rawDescGZIP(), []int{42, 3, 1}
}
...
func (*MetricsInfo_NetInfo_LatencyInfo) Descriptor() ([]byte, []int) {
	return file_core_Tron_proto_rawDescGZIP(), []int{42, 3, 2}
}
...
func (*MetricsInfo_NetInfo_ApiInfo_ApiDetailInfo) Descriptor() ([]byte, []int) {
	return file_core_Tron_proto_rawDescGZIP(), []int{42, 3, 0, 0}
}
...
func (*MetricsInfo_NetInfo_LatencyInfo_LatencyDetailInfo) Descriptor() ([]byte, []int) {
	return file_core_Tron_proto_rawDescGZIP(), []int{42, 3, 2, 0}
}
...
func (x *PBFTMessage_Raw) Reset() {
	*x = PBFTMessage_Raw{}
	mi := &file_core_Tron_proto_msgTypes[87]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_core_Tron_proto_rawDesc = "" +
	...
	"\x06weight\x18\x02 \x01(\x03R\x06weight\"t\n" +
	"\tPQAuthSig\x12*\n" +
	"\x06scheme\x18\x01 \x01(\x0e2\x12.protocol.PQSchemeR\x06scheme\x12\x1d\n" +
	"\n" +
	"public_key\x18\x02 \x01(\fR\tpublicKey\x12\x1c\n" +
	"\tsignature\x18\x03 \x01(\fR\tsignature\"\xa3\x02\n" +
	...
	"\x0ffillBuyQuantity\x18\x04 \x01(\x03R\x0ffillBuyQuantity\"\x92\x19\n" +
	"\vTransaction\x124\n" +
	"\braw_data\x18\x01 \x01(\v2\x19.protocol.Transaction.rawR\arawData\x12\x1c\n" +
	"\tsignature\x18\x02 \x03(\fR\tsignature\x12.\n" +
	"\x03ret\x18\x05 \x03(\v2\x1c.protocol.Transaction.ResultR\x03ret\x123\n" +
	"\vpq_auth_sig\x18\x06 \x03(\v2\x13.protocol.PQAuthSigR\tpqAuthSig\x1a\xef\n" +
	"\n" +
	"\bContract\x12?\n" +
	...
	"\fTransactions\x129\n" +
	"\ftransactions\x18\x01 \x03(\v2\x15.protocol.TransactionR\ftransactions\"\xb1\x03\n" +
	"\vBlockHeader\x124\n" +
	"\braw_data\x18\x01 \x01(\v2\x19.protocol.BlockHeader.rawR\arawData\x12+\n" +
	"\x11witness_signature\x18\x02 \x01(\fR\x10witnessSignature\x123\n" +
	"\vpq_auth_sig\x18\x03 \x01(\v2\x13.protocol.PQAuthSigR\tpqAuthSig\x1a\x89\x02\n" +
	"\x03raw\x12\x1c\n" +
	...
	"\x06reason\x18\x01 \x01(\x0e2\x14.protocol.ReasonCodeR\x06reason\"\xc6\x04\n" +
	"\fHelloMessage\x12&\n" +
	...
	"\vcodeVersion\x18\v \x01(\fR\vcodeVersion\x123\n" +
	"\vpq_auth_sig\x18\f \x01(\v2\x13.protocol.PQAuthSigR\tpqAuthSig\x1a5\n" +
	"\aBlockId\x12\x12\n" +
	"\x04hash\x18\x01 \x01(\fR\x04hash\x12\x16\n" +
	...
	"\bContract\x10\x02*@\n" +
	"\bPQScheme\x12\x15\n" +
	"\x11UNKNOWN_PQ_SCHEME\x10\x00\x12\x0e\n" +
	"\n" +
	"FN_DSA_512\x10\x01\x12\r\n" +
	"\tML_DSA_44\x10\x02*\x9f\x04\n" +
	"\n" +
	"ReasonCode\x12\r\n" +
	...
	"\aUNKNOWN\x10\xff\x01BG\n" +
	"\x0forg.tron.protosB\bProtocolZ*github.com/tronprotocol/go-tron/proto/coreb\x06proto3"

var (
	file_core_Tron_proto_rawDescOnce sync.Once
	file_core_Tron_proto_rawDescData []byte
)

func file_core_Tron_proto_rawDescGZIP() []byte {
	file_core_Tron_proto_rawDescOnce.Do(func() {
		file_core_Tron_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_core_Tron_proto_rawDesc), len(file_core_Tron_proto_rawDesc)))
	})
	return file_core_Tron_proto_rawDescData
}

var file_core_Tron_proto_enumTypes = make([]protoimpl.EnumInfo, 15)
var file_core_Tron_proto_msgTypes = make([]protoimpl.MessageInfo, 88)
var file_core_Tron_proto_goTypes = []any{
	(AccountType)(0),                          // 0: protocol.AccountType
	(PQScheme)(0),                             // 1: protocol.PQScheme
	(ReasonCode)(0),                           // 2: protocol.ReasonCode
	(Proposal_State)(0),                       // 3: protocol.Proposal.State
	(MarketOrder_State)(0),                    // 4: protocol.MarketOrder.State
	(Permission_PermissionType)(0),            // 5: protocol.Permission.PermissionType
	(Transaction_Contract_ContractType)(0),    // 6: protocol.Transaction.Contract.ContractType
	(Transaction_ResultCode)(0),               // 7: protocol.Transaction.Result.code
	(Transaction_ResultContractResult)(0),     // 8: protocol.Transaction.Result.contractResult
	(TransactionInfoCode)(0),                  // 9: protocol.TransactionInfo.code
	(BlockInventory_Type)(0),                  // 10: protocol.BlockInventory.Type
	(Inventory_InventoryType)(0),              // 11: protocol.Inventory.InventoryType
	(Items_ItemType)(0),                       // 12: protocol.Items.ItemType
	(PBFTMessage_MsgType)(0),                  // 13: protocol.PBFTMessage.MsgType
	(PBFTMessage_DataType)(0),                 // 14: protocol.PBFTMessage.DataType
	(*AccountId)(nil),                         // 15: protocol.AccountId
	(*Vote)(nil),                              // 16: protocol.Vote
	(*Proposal)(nil),                          // 17: protocol.Proposal
	(*Exchange)(nil),                          // 18: protocol.Exchange
	(*MarketOrder)(nil),                       // 19: protocol.MarketOrder
	(*MarketOrderList)(nil),                   // 20: protocol.MarketOrderList
	(*MarketOrderPairList)(nil),               // 21: protocol.MarketOrderPairList
	(*MarketOrderPair)(nil),                   // 22: protocol.MarketOrderPair
	(*MarketAccountOrder)(nil),                // 23: protocol.MarketAccountOrder
	(*MarketPrice)(nil),                       // 24: protocol.MarketPrice
	(*MarketPriceList)(nil),                   // 25: protocol.MarketPriceList
	(*MarketOrderIdList)(nil),                 // 26: protocol.MarketOrderIdList
	(*ChainParameters)(nil),                   // 27: protocol.ChainParameters
	(*Account)(nil),                           // 28: protocol.Account
	(*Key)(nil),                               // 29: protocol.Key
	(*PQAuthSig)(nil),                         // 30: protocol.PQAuthSig
	(*DelegatedResource)(nil),                 // 31: protocol.DelegatedResource
	(*Authority)(nil),                         // 32: protocol.authority
	(*Permission)(nil),                        // 33: protocol.Permission
	(*Witness)(nil),                           // 34: protocol.Witness
	(*Votes)(nil),                             // 35: protocol.Votes
	(*TXOutput)(nil),                          // 36: protocol.TXOutput
	(*TXInput)(nil),                           // 37: protocol.TXInput
	(*TXOutputs)(nil),                         // 38: protocol.TXOutputs
	(*ResourceReceipt)(nil),                   // 39: protocol.ResourceReceipt
	(*MarketOrderDetail)(nil),                 // 40: protocol.MarketOrderDetail
	(*Transaction)(nil),                       // 41: protocol.Transaction
	(*TransactionInfo)(nil),                   // 42: protocol.TransactionInfo
	(*TransactionRet)(nil),                    // 43: protocol.TransactionRet
	(*Transactions)(nil),                      // 44: protocol.Transactions
	(*BlockHeader)(nil),                       // 45: protocol.BlockHeader
	(*Block)(nil),                             // 46: protocol.Block
	(*ChainInventory)(nil),                    // 47: protocol.ChainInventory
	(*BlockInventory)(nil),                    // 48: protocol.BlockInventory
	(*Inventory)(nil),                         // 49: protocol.Inventory
	(*Items)(nil),                             // 50: protocol.Items
	(*DynamicProperties)(nil),                 // 51: protocol.DynamicProperties
	(*DisconnectMessage)(nil),                 // 52: protocol.DisconnectMessage
	(*HelloMessage)(nil),                      // 53: protocol.HelloMessage
	(*InternalTransaction)(nil),               // 54: protocol.InternalTransaction
	(*DelegatedResourceAccountIndex)(nil),     // 55: protocol.DelegatedResourceAccountIndex
	(*NodeInfo)(nil),                          // 56: protocol.NodeInfo
	(*MetricsInfo)(nil),                       // 57: protocol.MetricsInfo
	(*PBFTMessage)(nil),                       // 58: protocol.PBFTMessage
	(*PBFTCommitResult)(nil),                  // 59: protocol.PBFTCommitResult
	(*SRL)(nil),                               // 60: protocol.SRL
	nil,                                       // 61: protocol.Proposal.ParametersEntry
	(*ChainParameters_ChainParameter)(nil),    // 62: protocol.ChainParameters.ChainParameter
	(*Account_Frozen)(nil),                    // 63: protocol.Account.Frozen
	nil,                                       // 64: protocol.Account.AssetEntry
	nil,                                       // 65: protocol.Account.AssetV2Entry
	nil,                                       // 66: protocol.Account.LatestAssetOperationTimeEntry
	nil,                                       // 67: protocol.Account.LatestAssetOperationTimeV2Entry
	nil,                                       // 68: protocol.Account.FreeAssetNetUsageEntry
	nil,                                       // 69: protocol.Account.FreeAssetNetUsageV2Entry
	(*Account_AccountResource)(nil),           // 70: protocol.Account.AccountResource
	(*Account_FreezeV2)(nil),                  // 71: protocol.Account.FreezeV2
	(*Account_UnFreezeV2)(nil),                // 72: protocol.Account.UnFreezeV2
	(*TXInputRaw)(nil),                        // 73: protocol.TXInput.raw
	(*Transaction_Contract)(nil),              // 74: protocol.Transaction.Contract
	(*Transaction_Result)(nil),                // 75: protocol.Transaction.Result
	(*TransactionRaw)(nil),                    // 76: protocol.Transaction.raw
	nil,                                       // 77: protocol.Transaction.Result.CancelUnfreezeV2AmountEntry
	(*TransactionInfo_Log)(nil),               // 78: protocol.TransactionInfo.Log
	nil,                                       // 79: protocol.TransactionInfo.CancelUnfreezeV2AmountEntry
	(*BlockHeaderRaw)(nil),                    // 80: protocol.BlockHeader.raw
	(*ChainInventory_BlockId)(nil),            // 81: protocol.ChainInventory.BlockId
	(*BlockInventory_BlockId)(nil),            // 82: protocol.BlockInventory.BlockId
	(*HelloMessage_BlockId)(nil),              // 83: protocol.HelloMessage.BlockId
	(*InternalTransaction_CallValueInfo)(nil), // 84: protocol.InternalTransaction.CallValueInfo
	nil,                             // 85: protocol.NodeInfo.CheatWitnessInfoMapEntry
	(*NodeInfo_PeerInfo)(nil),       // 86: protocol.NodeInfo.PeerInfo
	(*NodeInfo_ConfigNodeInfo)(nil), // 87: protocol.NodeInfo.ConfigNodeInfo
	(*NodeInfo_MachineInfo)(nil),    // 88: protocol.NodeInfo.MachineInfo
	(*NodeInfo_MachineInfo_MemoryDescInfo)(nil),               // 89: protocol.NodeInfo.MachineInfo.MemoryDescInfo
	(*NodeInfo_MachineInfo_DeadLockThreadInfo)(nil),           // 90: protocol.NodeInfo.MachineInfo.DeadLockThreadInfo
	(*MetricsInfo_NodeInfo)(nil),                              // 91: protocol.MetricsInfo.NodeInfo
	(*MetricsInfo_BlockChainInfo)(nil),                        // 92: protocol.MetricsInfo.BlockChainInfo
	(*MetricsInfo_RateInfo)(nil),                              // 93: protocol.MetricsInfo.RateInfo
	(*MetricsInfo_NetInfo)(nil),                               // 94: protocol.MetricsInfo.NetInfo
	(*MetricsInfo_BlockChainInfo_Witness)(nil),                // 95: protocol.MetricsInfo.BlockChainInfo.Witness
	(*MetricsInfo_BlockChainInfo_DupWitness)(nil),             // 96: protocol.MetricsInfo.BlockChainInfo.DupWitness
	(*MetricsInfo_NetInfo_ApiInfo)(nil),                       // 97: protocol.MetricsInfo.NetInfo.ApiInfo
	(*MetricsInfo_NetInfo_DisconnectionDetailInfo)(nil),       // 98: protocol.MetricsInfo.NetInfo.DisconnectionDetailInfo
	(*MetricsInfo_NetInfo_LatencyInfo)(nil),                   // 99: protocol.MetricsInfo.NetInfo.LatencyInfo
	(*MetricsInfo_NetInfo_ApiInfo_ApiDetailInfo)(nil),         // 100: protocol.MetricsInfo.NetInfo.ApiInfo.ApiDetailInfo
	(*MetricsInfo_NetInfo_LatencyInfo_LatencyDetailInfo)(nil), // 101: protocol.MetricsInfo.NetInfo.LatencyInfo.LatencyDetailInfo
	(*PBFTMessage_Raw)(nil),                                   // 102: protocol.PBFTMessage.Raw
	(*Endpoint)(nil),                                          // 103: protocol.Endpoint
	(ResourceCode)(0),                                         // 104: protocol.ResourceCode
	(*anypb.Any)(nil),                                         // 105: google.protobuf.Any
}
var file_core_Tron_proto_depIdxs = []int32{
	61,  // 0: protocol.Proposal.parameters:type_name -> protocol.Proposal.ParametersEntry
	3,   // 1: protocol.Proposal.state:type_name -> protocol.Proposal.State
	4,   // 2: protocol.MarketOrder.state:type_name -> protocol.MarketOrder.State
	19,  // 3: protocol.MarketOrderList.orders:type_name -> protocol.MarketOrder
	22,  // 4: protocol.MarketOrderPairList.orderPair:type_name -> protocol.MarketOrderPair
	24,  // 5: protocol.MarketPriceList.prices:type_name -> protocol.MarketPrice
	62,  // 6: protocol.ChainParameters.chainParameter:type_name -> protocol.ChainParameters.ChainParameter
	0,   // 7: protocol.Account.type:type_name -> protocol.AccountType
	16,  // 8: protocol.Account.votes:type_name -> protocol.Vote
	64,  // 9: protocol.Account.asset:type_name -> protocol.Account.AssetEntry
	65,  // 10: protocol.Account.assetV2:type_name -> protocol.Account.AssetV2Entry
	63,  // 11: protocol.Account.frozen:type_name -> protocol.Account.Frozen
	63,  // 12: protocol.Account.tron_power:type_name -> protocol.Account.Frozen
	63,  // 13: protocol.Account.frozen_supply:type_name -> protocol.Account.Frozen
	66,  // 14: protocol.Account.latest_asset_operation_time:type_name -> protocol.Account.LatestAssetOperationTimeEntry
	67,  // 15: protocol.Account.latest_asset_operation_timeV2:type_name -> protocol.Account.LatestAssetOperationTimeV2Entry
	68,  // 16: protocol.Account.free_asset_net_usage:type_name -> protocol.Account.FreeAssetNetUsageEntry
	69,  // 17: protocol.Account.free_asset_net_usageV2:type_name -> protocol.Account.FreeAssetNetUsageV2Entry
	70,  // 18: protocol.Account.account_resource:type_name -> protocol.Account.AccountResource
	33,  // 19: protocol.Account.owner_permission:type_name -> protocol.Permission
	33,  // 20: protocol.Account.witness_permission:type_name -> protocol.Permission
	33,  // 21: protocol.Account.active_permission:type_name -> protocol.Permission
	71,  // 22: protocol.Account.frozenV2:type_name -> protocol.Account.FreezeV2
	72,  // 23: protocol.Account.unfrozenV2:type_name -> protocol.Account.UnFreezeV2
	1,   // 24: protocol.PQAuthSig.scheme:type_name -> protocol.PQScheme
	15,  // 25: protocol.authority.account:type_name -> protocol.AccountId
	5,   // 26: protocol.Permission.type:type_name -> protocol.Permission.PermissionType
	29,  // 27: protocol.Permission.keys:type_name -> protocol.Key
	16,  // 28: protocol.Votes.old_votes:type_name -> protocol.Vote
	16,  // 29: protocol.Votes.new_votes:type_name -> protocol.Vote
	73,  // 30: protocol.TXInput.raw_data:type_name -> protocol.TXInput.raw
	36,  // 31: protocol.TXOutputs.outputs:type_name -> protocol.TXOutput
	8,   // 32: protocol.ResourceReceipt.result:type_name -> protocol.Transaction.Result.contractResult
	76,  // 33: protocol.Transaction.raw_data:type_name -> protocol.Transaction.raw
	75,  // 34: protocol.Transaction.ret:type_name -> protocol.Transaction.Result
	30,  // 35: protocol.Transaction.pq_auth_sig:type_name -> protocol.PQAuthSig
	39,  // 36: protocol.TransactionInfo.receipt:type_name -> protocol.ResourceReceipt
	78,  // 37: protocol.TransactionInfo.log:type_name -> protocol.TransactionInfo.Log
	9,   // 38: protocol.TransactionInfo.result:type_name -> protocol.TransactionInfo.code
	54,  // 39: protocol.TransactionInfo.internal_transactions:type_name -> protocol.InternalTransaction
	40,  // 40: protocol.TransactionInfo.orderDetails:type_name -> protocol.MarketOrderDetail
	79,  // 41: protocol.TransactionInfo.cancel_unfreezeV2_amount:type_name -> protocol.TransactionInfo.CancelUnfreezeV2AmountEntry
	42,  // 42: protocol.TransactionRet.transactioninfo:type_name -> protocol.TransactionInfo
	41,  // 43: protocol.Transactions.transactions:type_name -> protocol.Transaction
	80,  // 44: protocol.BlockHeader.raw_data:type_name -> protocol.BlockHeader.raw
	30,  // 45: protocol.BlockHeader.pq_auth_sig:type_name -> protocol.PQAuthSig
	41,  // 46: protocol.Block.transactions:type_name -> protocol.Transaction
	45,  // 47: protocol.Block.block_header:type_name -> protocol.BlockHeader
	81,  // 48: protocol.ChainInventory.ids:type_name -> protocol.ChainInventory.BlockId
	82,  // 49: protocol.BlockInventory.ids:type_name -> protocol.BlockInventory.BlockId
	10,  // 50: protocol.BlockInventory.type:type_name -> protocol.BlockInventory.Type
	11,  // 51: protocol.Inventory.type:type_name -> protocol.Inventory.InventoryType
	12,  // 52: protocol.Items.type:type_name -> protocol.Items.ItemType
	46,  // 53: protocol.Items.blocks:type_name -> protocol.Block
	45,  // 54: protocol.Items.block_headers:type_name -> protocol.BlockHeader
	41,  // 55: protocol.Items.transactions:type_name -> protocol.Transaction
	2,   // 56: protocol.DisconnectMessage.reason:type_name -> protocol.ReasonCode
	103, // 57: protocol.HelloMessage.from:type_name -> protocol.Endpoint
	83,  // 58: protocol.HelloMessage.genesisBlockId:type_name -> protocol.HelloMessage.BlockId
	83,  // 59: protocol.HelloMessage.solidBlockId:type_name -> protocol.HelloMessage.BlockId
	83,  // 60: protocol.HelloMessage.headBlockId:type_name -> protocol.HelloMessage.BlockId
	30,  // 61: protocol.HelloMessage.pq_auth_sig:type_name -> protocol.PQAuthSig
	84,  // 62: protocol.InternalTransaction.callValueInfo:type_name -> protocol.InternalTransaction.CallValueInfo
	86,  // 63: protocol.NodeInfo.peerInfoList:type_name -> protocol.NodeInfo.PeerInfo
	87,  // 64: protocol.NodeInfo.configNodeInfo:type_name -> protocol.NodeInfo.ConfigNodeInfo
	88,  // 65: protocol.NodeInfo.machineInfo:type_name -> protocol.NodeInfo.MachineInfo
	85,  // 66: protocol.NodeInfo.cheatWitnessInfoMap:type_name -> protocol.NodeInfo.CheatWitnessInfoMapEntry
	91,  // 67: protocol.MetricsInfo.node:type_name -> protocol.MetricsInfo.NodeInfo
	92,  // 68: protocol.MetricsInfo.blockchain:type_name -> protocol.MetricsInfo.BlockChainInfo
	94,  // 69: protocol.MetricsInfo.net:type_name -> protocol.MetricsInfo.NetInfo
	102, // 70: protocol.PBFTMessage.raw_data:type_name -> protocol.PBFTMessage.Raw
	63,  // 71: protocol.Account.AccountResource.frozen_balance_for_energy:type_name -> protocol.Account.Frozen
	104, // 72: protocol.Account.FreezeV2.type:type_name -> protocol.ResourceCode
	104, // 73: protocol.Account.UnFreezeV2.type:type_name -> protocol.ResourceCode
	6,   // 74: protocol.Transaction.Contract.type:type_name -> protocol.Transaction.Contract.ContractType
	105, // 75: protocol.Transaction.Contract.parameter:type_name -> google.protobuf.Any
	7,   // 76: protocol.Transaction.Result.ret:type_name -> protocol.Transaction.Result.code
	8,   // 77: protocol.Transaction.Result.contractRet:type_name -> protocol.Transaction.Result.contractResult
	40,  // 78: protocol.Transaction.Result.orderDetails:type_name -> protocol.MarketOrderDetail
	77,  // 79: protocol.Transaction.Result.cancel_unfreezeV2_amount:type_name -> protocol.Transaction.Result.CancelUnfreezeV2AmountEntry
	32,  // 80: protocol.Transaction.raw.auths:type_name -> protocol.authority
	74,  // 81: protocol.Transaction.raw.contract:type_name -> protocol.Transaction.Contract
	89,  // 82: protocol.NodeInfo.MachineInfo.memoryDescInfoList:type_name -> protocol.NodeInfo.MachineInfo.MemoryDescInfo
	90,  // 83: protocol.NodeInfo.MachineInfo.deadLockThreadInfoList:type_name -> protocol.NodeInfo.MachineInfo.DeadLockThreadInfo
	93,  // 84: protocol.MetricsInfo.BlockChainInfo.blockProcessTime:type_name -> protocol.MetricsInfo.RateInfo
	93,  // 85: protocol.MetricsInfo.BlockChainInfo.tps:type_name -> protocol.MetricsInfo.RateInfo
	93,  // 86: protocol.MetricsInfo.BlockChainInfo.missedTransaction:type_name -> protocol.MetricsInfo.RateInfo
	95,  // 87: protocol.MetricsInfo.BlockChainInfo.witnesses:type_name -> protocol.MetricsInfo.BlockChainInfo.Witness
	96,  // 88: protocol.MetricsInfo.BlockChainInfo.dupWitness:type_name -> protocol.MetricsInfo.BlockChainInfo.DupWitness
	97,  // 89: protocol.MetricsInfo.NetInfo.api:type_name -> protocol.MetricsInfo.NetInfo.ApiInfo
	93,  // 90: protocol.MetricsInfo.NetInfo.tcpInTraffic:type_name -> protocol.MetricsInfo.RateInfo
	93,  // 91: protocol.MetricsInfo.NetInfo.tcpOutTraffic:type_name -> protocol.MetricsInfo.RateInfo
	98,  // 92: protocol.MetricsInfo.NetInfo.disconnectionDetail:type_name -> protocol.MetricsInfo.NetInfo.DisconnectionDetailInfo
	93,  // 93: protocol.MetricsInfo.NetInfo.udpInTraffic:type_name -> protocol.MetricsInfo.RateInfo
	93,  // 94: protocol.MetricsInfo.NetInfo.udpOutTraffic:type_name -> protocol.MetricsInfo.RateInfo
	99,  // 95: protocol.MetricsInfo.NetInfo.latency:type_name -> protocol.MetricsInfo.NetInfo.LatencyInfo
	93,  // 96: protocol.MetricsInfo.NetInfo.ApiInfo.qps:type_name -> protocol.MetricsInfo.RateInfo
	93,  // 97: protocol.MetricsInfo.NetInfo.ApiInfo.failQps:type_name -> protocol.MetricsInfo.RateInfo
	93,  // 98: protocol.MetricsInfo.NetInfo.ApiInfo.outTraffic:type_name -> protocol.MetricsInfo.RateInfo
	100, // 99: protocol.MetricsInfo.NetInfo.ApiInfo.detail:type_name -> protocol.MetricsInfo.NetInfo.ApiInfo.ApiDetailInfo
	101, // 100: protocol.MetricsInfo.NetInfo.LatencyInfo.detail:type_name -> protocol.MetricsInfo.NetInfo.LatencyInfo.LatencyDetailInfo
	93,  // 101: protocol.MetricsInfo.NetInfo.ApiInfo.ApiDetailInfo.qps:type_name -> protocol.MetricsInfo.RateInfo
	93,  // 102: protocol.MetricsInfo.NetInfo.ApiInfo.ApiDetailInfo.failQps:type_name -> protocol.MetricsInfo.RateInfo
	93,  // 103: protocol.MetricsInfo.NetInfo.ApiInfo.ApiDetailInfo.outTraffic:type_name -> protocol.MetricsInfo.RateInfo
	13,  // 104: protocol.PBFTMessage.Raw.msg_type:type_name -> protocol.PBFTMessage.MsgType
	14,  // 105: protocol.PBFTMessage.Raw.data_type:type_name -> protocol.PBFTMessage.DataType
...
func file_core_Tron_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_core_Tron_proto_rawDesc), len(file_core_Tron_proto_rawDesc)),
			NumEnums:      15,
			NumMessages:   88,
			NumExtensions: 0,
			NumServices:   0,
