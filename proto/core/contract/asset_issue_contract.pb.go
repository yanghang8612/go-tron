...
type AssetIssueContract struct {
	...
	TrxNum                  int32                              `protobuf:"varint,6,opt,name=trx_num,json=trxNum,proto3" json:"trx_num,omitempty"` // The fields trx_num and num define the exchange rate: num tokens can be purchased with trx_num TRX. This avoids using decimals.
...
type AssetIssueContract_FrozenSupply struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FrozenAmount  int64                  `protobuf:"varint,1,opt,name=frozen_amount,json=frozenAmount,proto3" json:"frozen_amount,omitempty"` // asset amount
...
const file_core_contract_asset_issue_contract_proto_rawDesc = "" +
	...
	"\x06amount\x18\x04 \x01(\x03R\x06amountBO\n" +
	"\x18org.tron.protos.contractZ3github.com/tronprotocol/go-tron/proto/core/contractb\x06proto3"
