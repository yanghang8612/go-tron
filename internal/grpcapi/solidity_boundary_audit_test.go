...
func TestSolidityServerBackendCallsAreAudited(t *testing.T) {
	expected := map[string][]string{
		...
		"GetAssetIssueListByName":            {"GetAssetIssueByNameAt"},
		...
		"GetDelegatedResource":               {"GetDelegatedResourceAt"},
		"GetDelegatedResourceAccountIndex":   {"GetDelegatedResourceAccountIndexAt"},
		...
		"GetPaginatedNowWitnessList":         {"ListWitnessesAt"},
