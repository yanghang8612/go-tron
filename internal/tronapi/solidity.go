...
func (api *API) RegisterSolidityRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("/walletsolidity/getpaginatednowwitnesslist", api.getSolidPaginatedNowWitnessList)
	...
	mux.HandleFunc("/walletsolidity/getassetissuebyaccount", api.getSolidAssetIssueByAccount)
...
func (api *API) RegisterPbftRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("/walletpbft/getpaginatednowwitnesslist", api.getPbftPaginatedNowWitnessList)
	...
	mux.HandleFunc("/walletpbft/getassetissuebyaccount", api.getPbftAssetIssueByAccount)
...
func (api *API) getSolidPaginatedNowWitnessList(w http.ResponseWriter, r *http.Request) {
	api.handleGetPaginatedNowWitnessList(w, r, api.solidBoundNum)
}

func (api *API) getPbftPaginatedNowWitnessList(w http.ResponseWriter, r *http.Request) {
	api.handleGetPaginatedNowWitnessList(w, r, api.pbftBoundNum)
}
...
func (api *API) getSolidAssetIssueByAccount(w http.ResponseWriter, r *http.Request) {
	api.handleGetAssetIssueByAccount(w, r, api.solidBoundNum)
}

func (api *API) getPbftAssetIssueByAccount(w http.ResponseWriter, r *http.Request) {
	api.handleGetAssetIssueByAccount(w, r, api.pbftBoundNum)
}
...
func (api *API) getSolidMarketOrderListByPair(w http.ResponseWriter, r *http.Request) {
	api.handleGetMarketOrderListByPair(w, r, api.solidBoundNum)
}
...
func (api *API) getSolidExchangeByID(w http.ResponseWriter, r *http.Request) {
	api.handleGetExchangeByID(w, r, api.solidBoundNum)
}

func (api *API) getPbftExchangeByID(w http.ResponseWriter, r *http.Request) {
