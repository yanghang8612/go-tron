...
func TestTronAPIBoundHandlersUseArchiveBackends(t *testing.T) {
	expectedArchive := map[string][]string{
		...
		"handleGetAssetIssueByAccount":             {"GetAssetIssueByAccount", "GetAssetIssueByAccountAt"},
		...
		"handleGetAssetIssueListByName":            {"GetAssetIssueByName", "GetAssetIssueByNameAt"},
		...
		"handleGetDelegatedResourceAccountIndex":   {"GetDelegatedResourceAccountIndex", "GetDelegatedResourceAccountIndexAt"},
		"handleGetDelegatedResourceV2":             {"GetDelegatedResourceV2", "GetDelegatedResourceV2At"},
		"handleGetDelegatedResource":               {"GetDelegatedResource", "GetDelegatedResourceAt"},
		"handleGetEnergyPrices":                    {"GetEnergyPrices", "GetEnergyPricesAt"},
		"handleGetExchangeByID":                    {"GetExchangeByID", "GetExchangeByIDAt"},
		"handleGetMarketOrderByID":                 {"GetMarketOrderByID", "GetMarketOrderByIDAt"},
		"handleGetMarketOrderListByPair":           {"GetMarketOrderListByPair", "GetMarketOrderListByPairAt"},
		"handleGetMarketOrdersFromAccount":         {"GetMarketOrdersByAccount", "GetMarketOrdersByAccountAt"},
		"handleGetMarketPairList":                  {"GetMarketPairList", "GetMarketPairListAt"},
		...
		"handleGetPaginatedNowWitnessList":         {"ListWitnesses", "ListWitnessesAt"},
	...
	expectedBoundGate := map[string][]string{
		...
		"handleGetAccountBalance":             {"GetAccountBalanceTrace"},
		"handleGetBlockBalanceTrace":          {"GetBlockBalanceTrace"},
...
func TestSolidityBoundWrappersCallExpectedHandlers(t *testing.T) {
	expected := map[string]tronAPIBoundWrapperCall{
		...
		"getPbftAccountBalance":                   {method: "handleGetAccountBalance", bound: "pbftBoundNum"},
		...
		"getPbftAssetIssueByAccount":              {method: "handleGetAssetIssueByAccount", bound: "pbftBoundNum"},
		...
		"getPbftAssetIssueListByName":             {method: "handleGetAssetIssueListByName", bound: "pbftBoundNum"},
		...
		"getPbftBlockBalanceTrace":                {method: "handleGetBlockBalanceTrace", bound: "pbftBoundNum"},
		...
		"getPbftDelegatedResourceAccountIndex":    {method: "handleGetDelegatedResourceAccountIndex", bound: "pbftBoundNum"},
		"getPbftDelegatedResourceV2":              {method: "handleGetDelegatedResourceV2", bound: "pbftBoundNum"},
		"getPbftDelegatedResource":                {method: "handleGetDelegatedResource", bound: "pbftBoundNum"},
		"getPbftEnergyPrices":                     {method: "handleGetEnergyPrices", bound: "pbftBoundNum"},
		"getPbftExchangeByID":                     {method: "handleGetExchangeByID", bound: "pbftBoundNum"},
		...
		"getPbftMarketOrderListByPair":            {method: "handleGetMarketOrderListByPair", bound: "pbftBoundNum"},
		"getPbftMarketOrdersFromAccount":          {method: "handleGetMarketOrdersFromAccount", bound: "pbftBoundNum"},
		"getPbftMarketPairList":                   {method: "handleGetMarketPairList", bound: "pbftBoundNum"},
		...
		"getPbftPaginatedNowWitnessList":          {method: "handleGetPaginatedNowWitnessList", bound: "pbftBoundNum"},
		...
		"getPbftTransactionReceiptByID":           {method: "handleGetTransactionInfoByIDAtBound", bound: "pbftBoundNum"},
		...
		"getSolidAccountBalance":                  {method: "handleGetAccountBalance", bound: "solidBoundNum"},
		...
		"getSolidAssetIssueByAccount":             {method: "handleGetAssetIssueByAccount", bound: "solidBoundNum"},
		...
		"getSolidAssetIssueListByName":            {method: "handleGetAssetIssueListByName", bound: "solidBoundNum"},
		...
		"getSolidBlockBalanceTrace":               {method: "handleGetBlockBalanceTrace", bound: "solidBoundNum"},
		...
		"getSolidDelegatedResourceAccountIndex":   {method: "handleGetDelegatedResourceAccountIndex", bound: "solidBoundNum"},
		"getSolidDelegatedResourceV2":             {method: "handleGetDelegatedResourceV2", bound: "solidBoundNum"},
		"getSolidDelegatedResource":               {method: "handleGetDelegatedResource", bound: "solidBoundNum"},
		"getSolidEnergyPrices":                    {method: "handleGetEnergyPrices", bound: "solidBoundNum"},
		"getSolidExchangeByID":                    {method: "handleGetExchangeByID", bound: "solidBoundNum"},
		...
		"getSolidMarketOrderListByPair":           {method: "handleGetMarketOrderListByPair", bound: "solidBoundNum"},
		"getSolidMarketOrdersFromAccount":         {method: "handleGetMarketOrdersFromAccount", bound: "solidBoundNum"},
		"getSolidMarketPairList":                  {method: "handleGetMarketPairList", bound: "solidBoundNum"},
		...
		"getSolidPaginatedNowWitnessList":         {method: "handleGetPaginatedNowWitnessList", bound: "solidBoundNum"},
		...
		"getSolidTransactionReceiptByID":          {method: "handleGetTransactionInfoByIDAtBound", bound: "solidBoundNum"},
